function varargout = meansepare2(varargin)

warning('meansepare2 : use grpmean2 instead');
varargout{1:nargout} = grpmean2(varargin{:});

% function [Ymean, Yste] = meansepare2(Y,X1, X2, subset, varargin)
